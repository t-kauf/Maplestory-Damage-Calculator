...
// Converted from artifact-potential-data.js to TypeScript

import type { ArtifactPotentialData } from '@ts/types/page/artifact-potential/artifact-potential.types';

export const artifactPotentialData: ArtifactPotentialData = {
    "Mystic": {
        "Main Stat %": 10,
